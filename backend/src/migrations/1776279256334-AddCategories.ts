...
export class AddCategories1776279256334 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category" RENAME COLUMN "userId" TO "createdById"`);
        await queryRunner.query(`ALTER TABLE "category" RENAME COLUMN "description" TO "defaultDescription"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_category_override" ADD CONSTRAINT "FK_1057371d415569f0360ce607b6a" FOREIGN KEY ("categoryId") REFERENCES "category"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category" RENAME COLUMN "createdById" TO "userId"`);
        await queryRunner.query(`ALTER TABLE "category" RENAME COLUMN "defaultDescription" TO "description"`);
